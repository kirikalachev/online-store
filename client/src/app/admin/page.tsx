...
export default function Home() {
  ...
  return (
    <main className="p-6 space-y-10 bg-gray-50 min-h-screen">
      <h1 className="text-3xl font-semibold text-gray-800">Администраторски панел</h1>

      {/* Управление на продуктите */}
      <section className="bg-white p-6 rounded-xl shadow-sm space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold text-gray-800">Управление на продуктите</h2>
          <button
        ...
        <h3 className="text-lg font-medium text-gray-700">Създадени продукти</h3>
      ...
      <section className="bg-white p-6 rounded-xl shadow-sm space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold text-gray-800">Управление на категориите</h2>
          <button
            className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg transition-colors"
        ...
        <h3 className="text-lg font-medium text-gray-700">Създадени категории</h3>
